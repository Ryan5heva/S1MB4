...
@section('page-subtitle', Auth::user()->isSuperAdmin() ? 'Riwayat Aktivitas & Kelola Pengguna' : 'Riwayat Aktivitas')

@section('content')

{{-- ============================================================
     SECTION 1 — RIWAYAT AKTIVITAS (Admin & Super Admin)
============================================================ --}}
<div class="mb-8">
...
{{-- ============================================================
     SECTION 2 — KELOLA PENGGUNA (Super Admin saja)
============================================================ --}}
@if(Auth::user()->isSuperAdmin())
<div>
